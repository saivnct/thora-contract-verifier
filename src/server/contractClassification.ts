...
export function isERC20Contract(abi: ABI[]){
    return verifyContract(abi, requiredFunctionsERC20, requiredEventsERC20);
}

export function isERC721Contract(abi: ABI[]){
    return verifyContract(abi, requiredFunctionsERC721, requiredEventsERC721);
}

export function isERC1155Contract(abi: ABI[]){
    return verifyContract(abi, requiredFunctionsERC1155, requiredEventsERC1155);
}

export function getContractType(abi: ABI[]) : ContractType{
    if (isERC20Contract(abi)){
        return "erc20";
    } else if (isERC721Contract(abi)){
        return "erc721";
    } else if (isERC1155Contract(abi)){
        return "erc1155";
    }
